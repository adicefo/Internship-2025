...
INSERT INTO company_price (id, price_per_kilometer, adding_date) VALUES
                                                                     ...
                                                                     (3, 3.06, NOW());
INSERT INTO route (
    id, source_point_lat, source_point_lon, destination_point_lat, destination_point_lon,
    status, client_id, company_price_id, driver_id, number_of_kilometers, full_price
) VALUES
      (1, 38.592187, -121.782024, 37.910617, -121.793017, 'wait', 1, 1, 1, 75.787, 3.01 * 75.787),
      (2, 38.523458, -121.463208, 37.519529, -120.935512, 'wait', 2, 2, 1, 120.823, 3.045 * 120.823),
      (3, 37.893279, -121.221347, 37.641422, -122.375726, 'wait', 2, 3, 2, 105.263, 3.06 * 105.263),
      (4, 38.557831, -121.485239, 36.600094, -119.745856, 'wait', 1, 3, 2, 266.227, 3.06 * 266.227),
      (5, 37.321893, -121.913084, 37.344823, -122.051879, 'wait', 1, 3, 1, 12.533, 3.06 * 12.533);
INSERT INTO rent (
    id, rent_date, end_date, number_of_days, vehicle_id, client_id, full_price, status
) VALUES
      (1, NOW() + INTERVAL '10 days', NOW() + INTERVAL '13 days', 3, 1, 1, 120, 'wait'),
      (2, NOW() + INTERVAL '13 days', NOW() + INTERVAL '23 days', 10, 2, 1, 550, 'wait'),
      (3, NOW() + INTERVAL '10 days', NOW() + INTERVAL '15 days', 5, 5, 2, 225, 'wait'),
      (4, NOW() + INTERVAL '3 days', NOW() + INTERVAL '7 days', 4, 4, 2, 196, 'wait'),
      (5, NOW() - INTERVAL '3 days', NOW() + INTERVAL '7 days', 10, 1, 2, 400, 'active'),
      (6, NOW() - INTERVAL '2 days', NOW() + INTERVAL '4 days', 6, 3, 1, 306, 'active'),
      (7, NOW() - INTERVAL '20 days', NOW() - INTERVAL '11 days', 9, 2, 1, 495, 'finished');
